...
void _investmentModelSerialize(
  ...
  writer.writeDouble(offsets[2], object.investedAmount);
...
InvestmentModel _investmentModelDeserialize(
  ...
  object.id = id;
  object.investedAmount = reader.readDouble(offsets[2]);
...
void _investmentModelAttach(
    IsarCollection<dynamic> col, Id id, InvestmentModel object) {
  object.id = id;
}
...
extension InvestmentModelQueryWhereSort
  ...
  QueryBuilder<InvestmentModel, InvestmentModel, QAfterWhere>
      anyPurchaseDate() {
    return QueryBuilder.apply(this, (query) {
...
extension InvestmentModelQueryWhere
  ...
  QueryBuilder<InvestmentModel, InvestmentModel, QAfterWhereClause> typeEqualTo(
      String type) {
    return QueryBuilder.apply(this, (query) {
